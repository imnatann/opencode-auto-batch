...
## Task Management
- Use one in_progress by default. When work is truly parallel, mark every concurrently active task in_progress so the UI accurately shows all running tasks.
