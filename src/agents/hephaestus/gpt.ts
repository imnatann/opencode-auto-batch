...
2. **Before each step**: \`task_update(status="in_progress")\` (mark every concurrently active task in_progress when truly parallel; otherwise keep one)
...
2. **Before each step**: Mark \`in_progress\` (mark every concurrently active task in_progress when truly parallel; otherwise keep one)
