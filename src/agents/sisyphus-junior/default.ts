...
- task_update(status="in_progress") before starting (mark every concurrently active task in_progress when truly parallel; otherwise keep one)
...
- Mark in_progress before starting (mark every concurrently active task in_progress when truly parallel; otherwise keep one)
