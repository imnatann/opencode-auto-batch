...
- **Starting step** — task_update(status="in_progress") — mark every concurrently active task in_progress when truly parallel; otherwise keep one
...
- **Starting step** — Mark in_progress — mark every concurrently active task in_progress when truly parallel; otherwise keep one
